...
public class Relational {
    ...
    public static void main(String[] args) {
        ...
        String language4 = "Turkish";

        System.out.println(language1 == language2); // false
        System.out.println(language1 == language3); // false ===> because Java is case-sensitive language
        System.out.println(language1 == language4); // true ===> because Java is case-sensitive language
        System.out.println("Russian" == "English"); // false


        //  != :

        System.out.println("Russian Language" == "English Language"); // false
        System.out.println("Russian Language" != "English Language"); // true
