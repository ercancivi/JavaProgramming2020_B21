package day24_NestedLoopContinue;
        ...
        /*  WarmUp Tasks 3:
    		...
    		Ex:
    			 ...
    			 output:
    			 		BD
	 		approach:
	 				find the frequency of each character one by one,
	 				and if the frequency of the character is equal to 1, it means it's unique
